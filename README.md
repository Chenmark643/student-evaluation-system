...
- Windows 提供轻量安装包、含 WebView2 的完整离线安装包，以及程序内在线更新。
...
推送 `v*` 标签后，GitHub Actions 会构建对应平台产物并发布到 GitHub Release。Windows 客户端读取 `update-windows.json`，核对版本、文件大小和 SHA-256 后才允许安装。详细流程见 [在线更新发布说明](docs/在线更新发布说明.md)。
